...
def generateDrivers(n = random.randint(3,25)):
    ...
    if not exists:
        ...
        shifts = [1, 2, 3]                                          #Numery zmian etatowych (rozszyfrowanie w głównym programie)
        random.shuffle(shifts)                                      #Wymieszanie kolejności
